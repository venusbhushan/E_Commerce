        ...
        <div class="row"><!-- row Begin -->
            ...
            <div class="col-sm-6 col-md-3"><!-- col-sm-6 col-md-3 Begin -->
                ...
                <p><!-- p Start -->
                    ...
                    <strong>Venus Bhushan</strong>
                    <br/>KIIT University
                    <br/>Bhubaneshwar,
                    Odisha,
                    Earth
                    <br/><strong>IG-Samael.84</strong>
            ...
            <div class="col-sm-6 col-md-3">
                ...
                <p class="social">
                    <a href="https://www.instagram.com/samael.84/" class="fa fa-instagram"></a>
            <!--
...
<div id="copyright"><!-- #copyright Begin -->
    <div class="container"><!-- container Begin -->
        <div class="col-md-6"><!-- col-md-6 Begin -->
            ...
            <p class="pull-left">&copy; 2020 Venus Bhushan</p>

        </div><!-- col-md-6 Finish -->
        <div class="col-md-6"><!-- col-md-6 Begin -->

            <p class="pull-right"><a href="http://localhost/found/DOIT/index.php">Home</a></p>
